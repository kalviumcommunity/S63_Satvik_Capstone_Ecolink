    ...
    >
      <div className="bg-white dark:bg-neutral-800 rounded-2xl shadow-soft p-8 border border-neutral-100 dark:border-neutral-700">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-2">Create an Account</h2>
          <p className="text-neutral-600 dark:text-neutral-400">Join our community of environmental enthusiasts</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center">
            <input
              ...
              required
            />
            <label htmlFor="terms" className="ml-2 block text-sm text-neutral-600 dark:text-neutral-400">
              I agree to the{' '}
